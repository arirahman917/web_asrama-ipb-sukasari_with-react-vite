  ...
  return (
    <footer id="footer" ref={footerRef} className="relative w-full bg-[#FAF9F6] flex flex-col">
      ...
      >
        ...
        {/* Footer Bottom Bar */}
        <div className="max-w-6xl mx-auto px-8 md:px-16 mt-16 flex flex-col md:flex-row justify-between items-center text-[12px] text-gray-400">
          <p>© Asrama IPB Sukasari 2026</p>
